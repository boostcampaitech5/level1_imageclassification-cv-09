...
def train(data_dir, model_dir, args):
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            wandb.log({"[Val] acc": val_acc, "loss": val_loss})
            print(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--project", type=str, default="exp_proj", help="model plot at {project}"
    )
    parser.add_argument(
        "--model_dir",
        type=str,
        default=os.environ.get("SM_MODEL_DIR", "/opt/ml/workspace/model"),
    )
    parser.add_argument(
        "--data_dir",
        type=str,
