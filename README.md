...
- `--model-name`, `--i`, `--random-seed`, `--weighted-ensemble`, `--soft-voting` : validation할 모델명, pretrained model의 index, 랜덤 시드, Weighted average ensemble 시 모델명, Soft Voting 시 모델명 
- 아래 그림은 출력 예시입니다.   
